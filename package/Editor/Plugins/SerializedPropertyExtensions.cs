...
namespace Disassembler.Editor.Plugins
{
    public static class SerializedPropertyExtensions
    {
        ...
        public static T GetValue<T>(this SerializedProperty property)
        {
            ...
            for (int i = 0; i < fieldStructure.Length; i++)
            {
                ...
                {
                    int index = global::System.Convert.ToInt32(new string(fieldStructure[i].Where(c => char.IsDigit(c)).ToArray()));
        ...
        public static bool SetValue<T>(this SerializedProperty property, T value)
        {
            ...
            {
                int index = global::System.Convert.ToInt32(new string(fieldName.Where(c => char.IsDigit(c)).ToArray()));
