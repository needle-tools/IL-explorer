...
namespace Disassembler.Editor.Plugins.SDILReader
{
    public class MethodBodyReader
    {
        ...
        private IList<ExceptionHandlingClause> ex;
        private IList<LocalVariableInfo> loc;

        public int ilByteCount => il != null ? il.Length : 0;
        public IList<ExceptionHandlingClause> ExceptionHandlingClauses => ex;
        public IList<LocalVariableInfo> LocalVariables => loc;
        ...
        public MethodBodyReader(MethodInfo mi)
        {
            ...
            if (mb != null)
            {
                ex = mb.ExceptionHandlingClauses;
                loc = mb.LocalVariables;
